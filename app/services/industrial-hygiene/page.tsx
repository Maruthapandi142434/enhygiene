          ...
          <div className="space-y-16">
            <div className="space-y-16">
              ...
              <section id="exposure">
                ...
                <Reveal as="p" delayMs={120} className="text-gray-700 leading-relaxed mb-6 text-justify">
              ...
              <section id="reporting">
                <div className="grid lg:grid-cols-2 gap-8 items-center">
                  {/* Image Left */}
                  <Reveal as="div" delayMs={0} className="relative h-80 sm:h-96 lg:h-[520px] w-full overflow-hidden rounded-xl shadow-md">
                    <Image src="/indurtial/WhatsApp Image 2025-09-17 at 16.19.57.jpeg" alt="Reporting and monitoring" fill className="object-contain" />
                  </Reveal>
                  {/* Content Right */}
                  <Reveal as="div" delayMs={140}>
                    <div className="flex items-start gap-3 mb-4">
